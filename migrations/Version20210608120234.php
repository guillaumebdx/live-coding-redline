 ...
 */
final class Version20210608120234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bottle (id INT AUTO_INCREMENT NOT NULL, castle_id INT NOT NULL, year INT NOT NULL, INDEX IDX_ACA9A9551BAF0DD4 (castle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
